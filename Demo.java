...
public class Demo {
	...
	public static void main(String[] args) {
		...
		people[4] = new Employee("Maria", 43, false, 32.25f);
		people[5] = new Employee("Ivelina", 25, false, 37.34f);
		...
		for (int index = 0; index < people.length; ++index) {
			...
			if (people[index] instanceof Employee) {
				System.out.print("Extra salary for " + people[index].getName() + ": ");
				System.out.printf("%.2f", ((Employee) people[index]).calculateOvertime(TWO_HOURS_OVERTIME));
				System.out.println();
			}
		}
